      ...
      <div className="nhsuk-width-container nhsuk-header__container">
          ...
          <div className="nhsuk-header__content" id="content-header">
            <div className="nhsuk-header__search">
              <div className="nhsuk-header__search-wrap" id="wrap-search">
                <form className="nhsuk-header__search-form" id="search" role="search" onSubmit={onSearchSubmit}>
                  <label className="nhsuk-u-visually-hidden" htmlFor="search-field">Search</label>
                  <input 
        ...
        {showNavigation && navigationItems.length > 0 && (
          <div className="nhsuk-header__menu" id="header-menu">
            <div className="nhsuk-header__menu-toggle">
              <button className="nhsuk-header__menu-toggle-button" id="toggle-menu" aria-controls="header-navigation" aria-label="Open menu">
                Menu
              </button>
            </div>
              ...
              <div className="nhsuk-width-container">
                ...
                <ul className="nhsuk-header__navigation-list">
                  {navigationItems.map((item, index) => (
                    <li key={index} className="nhsuk-header__navigation-item">
        ...
        {accountText && (
          <div className="nhsuk-header__account">
            <span className="nhsuk-header__account-text">{accountText}</span>
          </div>
        )}
      </div>
    </header>
